<div class="bg-light py-3">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="<?php echo site_url(); ?>">Home</a> <span class="mx-2 mb-0">/</span> <a href="<?php echo site_url('checkout'); ?>">Checkout</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Order Placed</strong></div>
        </div>
    </div>
</div>
