...
<h2 class="content-heading">Product - Add</h2> 
<form method="post">
    <div class="row gutters-tiny">
        <div class="col-md-4">
            <div class="list-group">
                <a href="<?php echo site_url('product/add'); ?>" class="list-group-item list-group-item-action flex-column align-items-start active">
                        ...
                        <div class="block-content block-content-full">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-control js-select2" name="category_id" style="width: 100%;" data-placeholder="-- Choose --">
                                        ...
                                        <?php foreach ($categories as $key => $category) { ?>
                                            <option value="<?php echo $category['id']; ?>" <?php echo ($this->input->post('category_id') == $category['id']) ? "selected" : ""; ?>><?php echo ($category['parent']) ? "--  " : ""; ?><?php echo $category['name']; ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="sku" placeholder="SKU" value="<?php echo $this->input->post('sku') ?>" class="form-control">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control ckeditor" name="description" placeholder="Main Description" rows="8"><?php echo $this->input->post('description'); ?></textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control ckeditor" name="specification" placeholder="Specification" rows="8"><?php echo $this->input->post('specification'); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" id="product-featured" name="featured" value="1" <?php echo ($this->input->post('featured') == "1") ? "checked" : ""; ?>>
                                        <span class="css-control-indicator"></span> Yes
                                    </label>
                                    <label class="css-control css-control-secondary css-radio">
                                        <input type="radio" class="css-control-input" id="product-not-featured" name="featured" value="1" <?php echo ($this->input->post('featured') == "0") ? "checked" : ""; ?>>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="js-maxlength form-control" name="meta_title" maxlength="50" data-always-show="true" data-placement="top" placeholder="Meta Title" value="<?php echo $this->input->post('meta_title'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="js-tags-input form-control" data-height="34px" name="meta_tags" placeholder="Meta Tags" value="<?php echo $this->input->post('meta_tags') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="js-maxlength form-control" name="meta_description" maxlength="150" data-always-show="true" data-placement="top" placeholder="Meta Description" rows="2"><?php echo $this->input->post('meta_description'); ?></textarea>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" id="customer-active" name="inactive" value="0" checked>
                                        <span class="css-control-indicator"></span> Yes
                                    </label>
                                    <label class="css-control css-control-secondary css-radio">
                                        <input type="radio" class="css-control-input" id="customer-inactive" name="inactive" value="1">
                                        <span class="css-control-indicator"></span> No
                                    </label>
                                </div>
                            </div>
