...
<div class="bg-body-light border-b">
    <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
            ...
            <span class="breadcrumb-item active">Cashbacks</span>
        </nav>
    </div>
</div> 
        ...
        <a class="block block-rounded block-link-shadow">
            <div class="block-content block-content-full block-sticky-options">
                ...
                <div class="py-20 text-center">
                    ...
                    <div class="font-size-sm font-w600 text-uppercase text-muted">All Cashbacks</div>
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-6 col-xl-6">
        <a class="block block-rounded block-link-shadow" href="<?php echo site_url('cashback/for'); ?>">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                ...
                <div class="py-20 text-center">
                    ...
                    <div class="font-size-sm font-w600 text-uppercase text-muted">New Cashback</div>
                </div>
            </div>
        </a>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="search" value="<?php echo $this->input->get('search'); ?>" placeholder="Search cashbacks by ID, name...">
                    </div>
                    <hr class="row">
                </div>
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo site_url('cashback/listing'); ?>" class="btn btn-alt-danger btn-block mb-4">
                                Clear
                            </a>
                        </div>
                    </div>
	            ...
	            <tbody>
	            	<?php if(!empty($cashbacks)) { ?>
	                    <?php foreach($cashbacks as  $cashback) { ?>
	                        <tr>
	                            <th scope="row"><?php echo $cashback['id']; ?></th>
                                <td><?php echo $cashback['name']; ?></td>
                                <td><?php echo (strtotime($cashback['valid_from_date']) > 0) ? convert_db_time($cashback['valid_from_date'], "d/m/Y") : '-' ?></td>
                                <td <?php echo (strtotime($cashback['valid_to_date']) > 0) ? (time() > strtotime($cashback['valid_to_date']) ? 'class="text-danger"' : '') : ''; ?>><?php echo (strtotime($cashback['valid_to_date']) > 0) ? convert_db_time($cashback['valid_to_date'], "d/m/Y") : '-' ?></td>
	                            <td class="text-center">
	                                <a class="btn btn-lg btn-circle btn-alt-primary mr-5 mb-5" href="<?php echo site_url('cashback/edit/'.$cashback['id']); ?>">
	                                    <i class="fa fa-pencil"></i>
	                                </a>
	                                <a class="btn btn-lg btn-circle btn-alt-danger mr-5 mb-5 delete-confirm" href="<?php echo site_url('cashback/delete/'.$cashback['id']); ?>">
	                ...
	                <?php } else { ?>
	                    <tr>
	                        <td colspan="6">No cashbacks added yet</td>
	                    </tr>
	                <?php } ?>
	            </tbody>
	        </table>
