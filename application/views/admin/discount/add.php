...
<h2 class="content-heading">Discount - Add</h2>
            ...
            <div class="block block-rounded block-themed">
                ...
                <div class="block-content block-content-full">
				    ...
				    <div class="form-group" style="position: relative;">
				        ...
				        <input type="text" placeholder="Code" name="code" value="<?php echo $this->input->post('code') ?>" class="form-control" id="code">
				    ...
				    <div class="row">
				        <div class="col-md-4">
				            <div class="form-group for-shop">
				                ...
				                <input type="text" placeholder="Minimum Cart Value" name="min_cart_value" value="<?php echo $this->input->post('min_cart_value') ?>" class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <label class="css-control css-control-primary css-radio">
	                            <input type="radio" class="css-control-input" id="discount-active" name="inactive" value="0" checked>
	                            <span class="css-control-indicator"></span> Yes
	                        </label>
	                        <label class="css-control css-control-secondary css-radio">
	                            <input type="radio" class="css-control-input" id="discount-inactive" name="inactive" value="1">
