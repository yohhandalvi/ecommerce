            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Crafted with <i class="fa fa-heart text-pulse"></i> by TLB
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="<?php echo site_url(); ?>"><?php echo PROJECT_NAME; ?> 1.0</a> &copy; <span class="js-year-copy"></span>
                    </div>
                </div>
            </footer>
        </div>
