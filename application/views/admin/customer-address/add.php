	...
	<div class="row gutters-tiny">
		<div class="col-md-4">
			<div class="list-group">
				<a href="<?php echo site_url('customer/edit/'.$this->uri->segment(3)); ?>" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Info</h5>
					</div>
					<p class="mb-1">Personal, contact info and status related to customer.</p>
				</a>
				<a href="<?php echo site_url('customer-address/listing/'.$this->uri->segment(3)); ?>" class="list-group-item list-group-item-action flex-column align-items-start active">
					<div class="d-flex w-100 justify-content-between">
		            ...
		            <div class="block block-rounded block-themed">
		                ...
		                <div class="block-content block-content-full">
							...
							<div class="form-group">
								...
								<textarea name="address_line_1" placeholder="Address Line 1" rows="3" class="form-control"><?php echo $this->input->post('address_line_1') ?></textarea>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="city" placeholder="City" value="<?php echo $this->input->post('city') ?>" class="form-control">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="pin_code" placeholder="Pin Code" value="<?php echo $this->input->post('pin_code') ?>" class="form-control">
