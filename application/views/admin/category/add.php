...
<h2 class="content-heading">Category - Add</h2>
<form method="post">
		            	...
		            	<div class="col-md-12">
							...
							<select class="form-control js-select2" name="parent" style="width: 100%;" data-placeholder="-- Choose --">
								...
								<?php foreach ($categories as $key => $c) { ?>
									<option value="<?php echo $c['id']; ?>" <?php echo ($this->input->post('parent') == $c['id']) ? "selected" : ""; ?>><?php echo ($c['parent']) ? "--  " : ""; ?><?php echo $c['name']; ?></option>
								<?php } ?>
							</select>
	                ...
	                <div class="form-group row">
	                    ...
	                    <div class="col-12">
	                        <label class="css-control css-control-primary css-radio">
	                            <input type="radio" class="css-control-input" id="category-active" name="inactive" value="0" checked>
	                            <span class="css-control-indicator"></span> Yes
	                        </label>
	                        <label class="css-control css-control-secondary css-radio">
	                            <input type="radio" class="css-control-input" id="category-inactive" name="inactive" value="1">
