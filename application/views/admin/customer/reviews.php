	...
	<div class="row gutters-tiny">
		<div class="col-md-4">
			<div class="list-group">
				...
				<a href="<?php echo site_url('customer/reviews/'.$customer['id']); ?>" class="list-group-item list-group-item-action flex-column align-items-start active">
					<div class="d-flex w-100 justify-content-between">
						            ...
						            <tbody>
						            	<?php if(!empty($product_reviews)) { ?>
						                    <?php foreach($product_reviews as  $product_review) { ?>
						                        <tr>
						                    		<th class="text-center" scope="row"><?php echo $product_review['product_id']; ?></th>
