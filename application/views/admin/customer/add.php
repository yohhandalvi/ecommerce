...
<h2 class="content-heading">Customer - Add</h2>
<form method="post">
	<div class="row gutters-tiny">
		<div class="col-md-4">
			<div class="list-group">
				<a href="<?php echo site_url('customer/add'); ?>" class="list-group-item list-group-item-action flex-column align-items-start active">
				            ...
				            <div class="form-group row">
				                <div class="col-md-4">
									...
									<select class="form-control js-select2" name="title">
										...
										<option value="mr" <?php echo ($this->input->post('title') == "mr") ? "selected" : ""; ?>>Mr</option>
										<option value="mrs" <?php echo ($this->input->post('title') == "mrs") ? "selected" : ""; ?>>Mrs</option>
										<option value="miss" <?php echo ($this->input->post('title') == "miss") ? "selected" : ""; ?>>Miss</option>
									</select>
				                ...
				                <div class="col-12">
									...
									<select class="form-control js-select2" name="customer_group_id" style="width: 100%;" data-placeholder="-- Choose --">
										...
										<?php foreach ($customer_groups as $key => $customer_group) { ?>
											<option value="<?php echo $customer_group['id']; ?>" <?php echo ($this->input->post('customer_group_id') == $customer_group['id']) ? "selected" : ""; ?>><?php echo $customer_group['name']; ?></option>
										<?php } ?>
									</select>
